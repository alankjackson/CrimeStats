...
##---new---##
saveRDS(df2, file="~/Dropbox/CrimeStats/District8cRawData.rds")
...
dictionary <- c(
  ...
  "9417",     "",
  "^5 ",    "",
  "BELLA PINES$",     "BELLA PINE",
  "BENNIGTON",     "BENNINGTON"
)
dict <- Makedict(dictionary)
#   test them first
testregex(df2, "Street", dict)
