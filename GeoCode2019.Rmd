...
street_stds <- readRDS("~/Dropbox/CrimeStats/Street_Standard_Suffix.rds")
...
#for (i in 572:572) {
  if (unmatched[i,]$status!="success"){ # only the redo's
    ...
    a <- check_match(unmatched[i,], unmatched)
    if (is_tibble(a)) {
      unmatched[i,4:10] <- a[1,4:10]
...
#  W Memorial Loop Dr 29.774177, -95.442344
#  Memorial Loop Dr 29.775845, -95.431376
#  N Picnic Ln 29.76546, -95.4448
#  S Picnic Ln 29.763081, -95.437057
#  7\\d{3} MEMORIAL DR 29.768436, -95.447572
...
#source("Edit_Addresses.R") # load in address edits
source("SuffixEdits.R") # load in address edits
