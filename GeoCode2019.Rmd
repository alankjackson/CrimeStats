...
for (beat in samNW){
  unmatched$Address[mask&(unmatched$Beat==beat)] <-
    str_replace(unmatched$Address[mask&(unmatched$Beat==beat)], "SAM HOUSTON PKWY", "N SAM HOUSTON PKWY W")
}
for (beat in samNE){
  unmatched$Address[mask&(unmatched$Beat==beat)] <-
...
onlys <- c("FUQUA", "HOLLOW", "SILVER", "CURVEY")
...
generated <- bind_rows(generated, Gulf) 
