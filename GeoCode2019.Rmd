...
#
#   West Loop is W LOOP N/S FWY,   chamgeover is Buffalo Bayou
...
samSW <- c("17E30", "16E30", "16E40", "17E4", "17E40")
...
LoopSE = c("11H30", "11H20", "13D10", "14D10", "14D30", "14D20", "14D40", "15E40")
LoopSW = c("15E30", "15E10")
...
skips <- c("S HEIGHTS", "FWY", "HOMELESS", "PO BOX", "POBOX","TOMBALL", "HEMPSTEAD", "POST OAK", "1960", "WILCREST", " SAM ", "HONEYWELL", "BELLFORT", "AVENUE" )
...
onlys <- c(" FLORA ", "JUNIPER", "KINGSPASS")
...
generated <- bind_rows(generated, SSamE2) 
