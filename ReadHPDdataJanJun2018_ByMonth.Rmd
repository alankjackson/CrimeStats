...
dictionary <- c(
  ...
  "^2$",     "2ND",
  "^12355",     "",
  "^1Q01 ADLA",     "AVENIDA DE LAS AMERICAS",
  "^2501A ",     "",
  "^998B ",     "",
  "ACCESS SAN JACINTO C",     "SAN JACINTO COLLEGE",
  " AT MARGARET",     "",
  "^1733B ",     "",
  "^2261A ",     "",
  "^4411B ",     "",
  ...
  "801",     "",
  "74OO ",     "",
  "633RUSHCREEKDRAPT812",     "RUSHCREEK DR",
  " SUITE A 1",     "",
  " NW$",     "",
  " ST A$",     " ST",
  " AVE NORTH$",     " AVE",
...
dictionary <- c(
  "AMTELOPE", "ANTELOPE",
  "ANTIONE", "ANTOINE",
  "AVEN LAQUINTA", "AVENIDA LA QUINTA",
  "ATTN REGION V P", "",
  "ANYWHERE HOUSTON", "",
  "^AVENUE ", "AVE ",
  "^AN ", "",
...
dictionary <- c(
  " APT CD 1019",   "",
  "SH288IB MACGREGOR WAY N",   "SH 288",
  " C147",   ""
)
dict <- Makedict(dictionary)
#   test them first
...
dictionary <- c(
  ...
  " 120$", "",
  "^OST$", "OLD SPANISH TRL",
  "^O S T$", "OLD SPANISH TRL",
  "^OLD SPANISH$", "OLD SPANISH TRL",
  " F 1$", "",
  "WILDINDIGO", "WILD INDIGO",
  " ST B$", " ST",
  " CO 01 35$", "",
  " SERVICE RD", ""
)
...
dictionary <- c(
  "SAMHOUPKWY S 315", "SAM HOUSTON PKWY S",
  "SAM HTN PWY S 515", "SAM HOUSTON PKWY S",
  " 1209$", ""
)
dict <- Makedict(dictionary)
#   test them first
...
dictionary <- c(
                ...
                "HW 6", "TEXAS 6",
                "NORTH SAM HOUSTON PARKWAY EAST", "N SAM HOUSTON PKWY E",
                "KING JR$", "KING",
                "TRL FWY", "TRL",
                "PMB", "TRL",
                " 1010$", "",
