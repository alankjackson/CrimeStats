...
district <- "18f"  # Midwest Patrol Division
...
##---new---##
saveRDS(df, file="~/Dropbox/CrimeStats/District18fRawData.rds")
```
...
#   Apply
df2 <- applyregex(df2, "Street", dict)
df2$Street[grepl("^3M CENTER$",df2$Street)] <- NA
...
dictionary <- c(
                " BLVD \\w*$",     "BLVD",
                "BEVERLYHILL",    "BEVERLY HILL",
                "BEVERLY HILLS$",    "BEVERLY HILL",
                " ENT$",           "",
                " SOUTH$",       ""
)
dict <- Makedict(dictionary)
...
dictionary <- c(
      ...
      "WESTLOOP", "WEST LOOP",
      "WEST LOOP SOUTH LOOP", "WEST LOOP",
      "W IH 610 FWY S", "W LOOP",
      "^NORTH ([A-E,G-Z])", "N \\1",
      "NSH 6", "N SH 6"
)
dict <- Makedict(dictionary)
...
dictionary <- c(
                ...
                "FOUNTAINVIEW PVT", "FOUNTAIN VIEW",
                " 162 W", ""
)
dict <- Makedict(dictionary)
#   test them first
