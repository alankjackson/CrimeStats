...
district <- "17e"  # Midwest Patrol Division
beats <- c("17e10","17e20","17e30","17e40")
...
#     August 2017 district files missing, so read individual beat files instead. Oops, all August files missing.
#     February 2017 also missing
...
##---new---##
saveRDS(df2, file="~/Dropbox/CrimeStats/District17eRawData.rds")
```
