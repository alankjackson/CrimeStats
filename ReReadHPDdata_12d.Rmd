...
district <- "12d"  # Midwest Patrol Division
beats <- c("12d10","12d20","12d30","12d40", "12d50", "12d60", "12d70" )
...
dictionary <- c(
  "MALS 12 MAG 12 1ST MAW FPO AP 011 8182 779 60", "",
  "LOOP E$", "LOOP",
  "LOOP WEST", "LOOP"
)
dict <- Makedict(dictionary)
...
dictionary <- c(
  "^E SOUTH SAM HOUSTON", "SOUTH SAM HOUSTON PKWY E"
)
dict <- Makedict(dictionary)
#   test them first
testregex(df2, "Street", dict)
