...
##---new---##
saveRDS(df2, file="~/Dropbox/CrimeStats/District1aRawData.rds")
...
df2$Street <- str_replace(df2$Street,"^S$","S LOOP FWY")
...
df2$Street <- str_replace(df2$Street,"IH 610","N LOOP FWY") # North Loop Fwy
...
##---new---##
df2$Street <- str_replace(df2$Street,"^LOOP CENTRAL$","LP CENTRAL") 
df2$Street <- str_replace(df2$Street," LOOP$"," LOOP FWY") 
...
##---new---##
saveRDS(df2, file="~/Dropbox/CrimeStats/District1aReCleanData.rds")
```
