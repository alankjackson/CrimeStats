...
district <- "19g"  # South Central Patrol Division
beats <- c("19g10","19g20","19g30","19g40", "19g50")
...
##---new---##
saveRDS(df, file="~/Dropbox/CrimeStats/District19gRawData.rds")
```
...
#   Apply
df2 <- applyregex(df2, "Street", dict)
df2$Street[grepl("^900$",df2$Street)] <- NA
tail(head(sort(unique(df2$Street)),100),100)
...
dictionary <- c(
                "BELLAIREBLVD",       "BELLAIRE BLVD",
                "AIRE@",         "AIRE @",
                "DAIRYBROOK",      "DAIRY BROOK",
                "^NORTH ",       "N ",
                "^SOUTH ",       "S ",
                "^EAST ",       "E ",
                "^WEST ",       "W ",
                "N SH 6 HWY",    "HWY 6 N",
                "N SH 6",        "HWY 6 N",
                "MONTEVERDE",   "MONTVERDE",
                " HWY$",         "",
                "SAMHOUPKWY",     "SAM HOUSTON PKWY",
                " PRWY$",        "PKWY",
                " DRIV$",          "",
                " STRE$",          "",
                " SH6",            "SH 6",
