...
district <- "7c"  # Midwest Patrol Division
beats <- c("7c10","7c20","7c30","7c40", "7c50")
...
df2$Beat[df2$Beat=="7C60"] <- "1A10" # oops!
...
##---new---##
saveRDS(df2, file="~/Dropbox/CrimeStats/District7cRawData.rds")
```
...
dictionary <- c(
                ...
                "IH 45",  "NORTH FWY",
                "IH 610", "NORTH LOOP",
                "IH610 AND HOMESTEAD", "NORTH LOOP @ HOMESTEAD",
                "^ ", "",
                " ENT RAMP", "",
                " EXIT RAMP", "",
                "JOHN F KENNEDY", "JFK",
...
dictionary <- c(
                ...
                "PARKWAY 88$",   "PKWY",
                "N LOOP E$",   "NORTH LOOP",
                "NORTH LOOP EAST",   "NORTH LOOP",
                "NORTH LP E",     "NORTH LOOP",
                "N US 59 FWY", "EASTEX FWY",
                "PARKWAY EAST", "PKWY E"
)
dict <- Makedict(dictionary)
#   test them first
