...
df = readRDS("~/Dropbox/CrimeStats/District2aCleanData.rds")
...
workingset <- select(workingset,Address, Add1, Add2, Street.x, avglon, avglat)
...
mask <- !complete.cases(workingset)
latlong1 = geocode(paste(workingset[mask,]$Add1[1:2400], workingset[mask,]$Street[1:2400])) 
workingset$lon1 <- NA
workingset$lat1 <- NA
workingset$lon2 <- NA
workingset$lat2 <- NA
workingset[mask,]$lon1[1:2400] = latlong1$lon
workingset[mask,]$lat1[1:2400] = latlong1$lat

##### Run on 26th after 8PM 
geocode(paste(workingset[mask,]$Add1[2401], workingset[mask,]$Street[2401]))
latlong2 = geocode(paste(workingset[mask,]$Add1[2401:4549], workingset[mask,]$Street[2401:4549])) 
workingset[mask,]$lon1[2401:4549] = latlong2$lon
workingset[mask,]$lat1[2401:4549] = latlong2$lat
