...
mask1 <- is.na(workingset$Longitude) | is.na(workingset$Latitude)
...
workingset$lon2[mask1] = NA
workingset$lat2[mask1] = NA

workingset$lon2[mask1] = latlongs$Longitude
workingset$lat2[mask1] = latlongs$Latitude
workingset$type2[mask1] = latlongs$types
workingset$StreetName2[mask1] = latlongs$StreetName
workingset$LocType2[mask1] = latlongs$LocType
...
mask1 <- is.na(workingset$lon1)&is.na(workingset$Longitude)& !(workingset$type == "ZERO_RESULTS" & !is.na(workingset$LocType))
