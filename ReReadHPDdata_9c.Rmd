...
##---new---##
saveRDS(df2, file="~/Dropbox/CrimeStats/District9cRawData.rds")
...
dictionary <- c(
                ...
                "NORTH LOOP", "N LOOP",
                "N LOOP EAST", "N LOOP E FWY",
                "N LOOP E", "N LOOP E FWY",
                "@ MCCARTY",        "",
                "RAINYMEADOW", "RAINY MEADOW"
)
dict <- Makedict(dictionary)
#   test them first
testregex(df2, "Street", dict)
...
# take a guess
df2$Street <- str_replace(df2$Street, "^LOOP$","N LOOP FWY")
df2$Street <- str_replace(df2$Street, "^LOOP E$","N LOOP E FWY")
