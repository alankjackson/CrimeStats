...
district <- "6b"  # Midwest Patrol Division
beats <- c("6b10","6b20","6b30","6b40", "6b50","6b60")
...
##---new---##
saveRDS(df2, file="~/Dropbox/CrimeStats/District3bRawData.rds")
```
...
dictionary <- c(
  " B402", "",
  "NORTHBOUROUGH", "NORTHBOROUGH",
  "NRTHBOROUGH", "NORTHBOROUGH",
  " SER$", "",
  "OB$", "",
  "NORTH SAM$", "NORTH SAM HOUSTON PKWY",
  "PARKWAY E$", "PKWY",
  " 234$", "",
  " AP$", ""
)
...
dictionary <- c(
                ...
                "CR 627", "COUNTY ROAD 627",
                "^FWY$", "NORTH FWY",
                "^G ", "",
                "I 45 NORTH", "NORTH FWY",
                "IH 45[ A-Z]*$", "NORTH FWY",
                "^N$", "NORTH FWY",
