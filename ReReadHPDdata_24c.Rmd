...
district <- "24c"  # Midwest Patrol Division
beats <- c("24c10","24c20","24c30","24c40", "24c50")
...
##---new---##
saveRDS(df2, file="~/Dropbox/CrimeStats/District24cRawData.rds")
...
dictionary <- c(
                ...
                "E IH 610 FWY N", "EAST LOOP N FWY"
#                "PARKWAY N", "PKWY"
)
dict <- Makedict(dictionary)
#   test them first
...
dictionary <- c(
  "^NORTH$", "NORTH FWY",
  "^NORTHWEST$", "NORTHWEST FWY",
  "^N? ?US 59 ?\\w*$", "EASTEX FWY"
)
dict <- Makedict(dictionary)
#   test them first
testregex(df2, "Street", dict)
...
# take a guess
df2$Street <- str_replace(df2$Street, "^LOOP$","NORTH LOOP")
df2$Street <- str_replace(df2$Street, "^LOOP E$","NORTH LOOP")
